...
Route::group(['prefix' => 'blog'], function (){
    ...
    Route::get('category', 'BlogController@category')->name('get.blog.category');
    Route::get('post-detail', 'BlogController@postDetail')->name('get.blog.post_detail');
    Route::get('tag', 'BlogController@tag')->name('get.blog.tag');
});
